		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="supplier_findAll.action"><i
					...
					<div class="col-xs-12">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs pull-right">
								...
								<li class="pull-left header"><i class="fa fa-user"></i> <small>供应商列表</small>
								</li>
							</ul>
											...
											<table id="userList"
												...
												<tbody>
													<s:iterator value="#request.list" var="d">
														<tr>
															<td><s:property value="#d.supplierId" /></td>
															<td><s:property value="#d.supplierName" /></td>
															<td><s:property value="#d.telephone" /></td>
															<td><s:property value="#d.email" /></td>
															<td><s:property value="#d.address" /></td>
															<td><a
																href="supplier_delete.action?supplierId=<s:property value="#d.supplierId"/>">删除</a>
																<a
																href="supplier_findBySupplierId.action?supplierId=<s:property value="#d.supplierId"/>">修改</a>
															</td>
														</tr>
													</s:iterator>
												</tbody>
								...
								<div class="tab-pane" id="tab-content-edit">
									<div class="box box-info">
										...
										<form id="supplier-form" name="supplier-form"
											action="supplier_save.action" class="form-horizontal bv-form"
													...
													<div class="form-group has-feedback">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="supplierId"
																...
																data-bv-field="supplierId"><i
																class="form-control-feedback"
																data-bv-icon-for="supplierId" style="display: none;"></i>
