					...
					<div class="col-xs-12">
						<div class="box box-info">
							<div class="box-header">
								<h3 class="box-title">
									<i class="fa fa-user"></i>修改管理员基本信息
								</h3>
							</div>
							<form id="user-form" name="user-form"
								class="form-horizontal bv-form" action="admin_update.action"
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="adminId"
													value="<s:property value="#request.admin.adminId" />"
													name="adminId" placeholder="管理员Id"  readonly = "readonly" />
											</div>
										</div>
										<div class="form-group has-feedback">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="name"
													value="<s:property value="#request.admin.adminName" />"
													name="adminName" placeholder="姓名" data-bv-field="adminName">

												<i class="form-control-feedback"
													data-bv-icon-for="adminName" style="display: none;"></i> <small
													data-bv-validator="notEmpty"
													data-bv-validator-for="adminName" class="help-block"
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="phone"
													name="phone"
													value="<s:property value="#request.admin.phone" />"
													placeholder="手机">
											</div>
										</div>
										<div class="form-group has-feedback">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="email"
													value="<s:property value="#request.admin.email" />"
												...
												<label class="control-label">
													<div class="iradio_square-green" aria-checked="false"
														...
														<input type="radio" name="sex" data-flag="icheck"
															<c:if test="${requestScope.admin.sex=='男'}">checked</c:if>
													...
													<div class="iradio_square-green" aria-checked="false"
														...
														<input type="radio" name="sex" data-flag="icheck"
															...
															<c:if test="${requestScope.admin.sex=='女'}">checked</c:if>
															data-bv-field="sex"
															style="position: absolute; opacity: 0;">
														<ins class="iCheck-helper"
															style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="password"
													...
													value="<s:property value="#request.admin.password" />"
													...
													style="display: none;">请输入密码 </small>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="address"
													name="address"
													value="<s:property value="#request.admin.address" />"
													placeholder="地址">
											</div>
										</div>
									</div>
