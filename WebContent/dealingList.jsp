...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li  active><a href="dealing_findAll.action"><i
							class="fa fa-tags"></i> <span>销售管理</span></a></li>
				</ul>
				<!-- /.sidebar-menu -->
			</section>
			<!-- /.sidebar -->
												...
												<tbody>
													<s:iterator value="#request.list" var="d">
														<tr>
															...
															<td><s:property value="#d.customer.customerId" /></td>
															<td><s:property value="#d.admin.adminId" /></td>	
															<td><s:property value="#d.good.goodId" /></td>		
															<td><s:property value="#d.num" /></td>
															<td><s:property value="#d.price" /></td>
															<td><s:property value="#d.dealingTime" /></td>
															<td><a
																href="dealing_delete.action?dealingId=<s:property value="#d.id"/>">删除</a>
																<a
																href="dealing_update.action?dealingId=<s:property value="#d.id"/>">修改</a>
															</td>
														</tr>
													</s:iterator>
								...
								<div class="tab-pane" id="tab-content-edit">
									<div class="box box-info">
										<div class="box-header">
											<h3 class="box-title">
												<i class="fa fa-user"></i>出库信息
											</h3>
										</div>
										<form id="inshop-form" name="inshop-form" action="dealing_save.action"
											...
											<div class="box-body">
												<div class="col">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input name="customer.customerId" id="customerId"
																class="form-control" />		 
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input name="admin.adminId" id="adminId"
																class="form-control" value="${sessionScope.admin.adminId }" readonly = "readonly" />		 
														</div>
													</div>
													<div class="form-group">
														<label for="goodId" class="col-sm-3 control-label">出库商品</label>
														<div class="col-sm-8">
															<input name="good.goodId" id="goodId"
																class="form-control" />		 
														</div>
													<%-- 	<select name="good.goodId" id="goodId"
																class="form-control">
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input name="goodName" id="goodName"
																class="form-control" value="${requestScope.gg.goodName}" />		 
														</div>
													</div>
													<div class="form-group">
														<label for="price" class="col-sm-3 control-label">出库价格</label>
														<div class="col-sm-8">
															<input type="text" class="form-control" id="price"
																name="dealing.price" placeholder="出库价格">
														</div>
													</div>
													<div class="form-group">
														<label for="num" class="col-sm-3 control-label">出库数量</label>

														<div class="col-sm-8">
															<input type="text" class="form-control" id="num"
																name="dealing.num" placeholder="出库数量">
														</div>
													</div>
	...
	<script>
		$(function() {
			...
			$("#goodId").bind('blur', function() {
				$.ajax({
					 
					type : "post",
					url : "good_findByGoodName.action?good.goodId="+ $("#goodId").val(),
					dataType:"text", 
					error : function() {
						alert('查询失败!');
					},
