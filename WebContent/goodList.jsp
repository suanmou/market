					...
					<div class="col-xs-12">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs pull-right">
								...
								<li class="pull-left header"><i class="fa fa-user"></i> <small>商品列表</small>
								</li>
							</ul>
							<div class="tab-content">
												...
												<tbody>
													<s:iterator value="#request.list" var="d">
														<tr>
															...
															<td><s:property value="#d.goodName" /></td>
															<td><s:property value="#d.price" /></td>
															<td><s:property value="#d.goodtype.goodtypeId" /></td>
															<td><s:property value="#d.num" /></td>
															<td><s:property value="#d.originPrice" /></td>
															<td><a
																href="good_delete.action?good.goodId=<s:property value="#d.goodId"/>">删除</a>
																<a
																href="good_findByGoodId.action?good.goodId=<s:property value="#d.goodId"/>">修改</a>
															</td>
														</tr>
													</s:iterator>
												</tbody>
								...
								<div class="tab-pane" id="tab-content-edit">
									<div class="box box-info">
										<div class="box-header">
											<h3 class="box-title">
												<i class="fa fa-user"></i>商品详情 
											</h3>
										</div>
										<form id="user-form" name="user-form" action="good_save.action"
													...
													<div class="form-group has-feedback">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="goodId"
																name="good.goodId" placeholder="商品号" data-bv-field="goodId"><i
													...
													<div class="form-group has-feedback">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="goodName"
																name="good.goodName" placeholder="商品名称"
																data-bv-field="goodName"><i
																class="form-control-feedback" data-bv-icon-for="name"
																style="display: none;"></i> <small
																data-bv-validator="notEmpty"
													...
													<%-- <div class="form-group has-feedback">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="goodPrice"
																name="goodPrice" placeholder="商品价格"
													...
													<!-- <div class="form-group has-feedback">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="goodNum"
																name="goodNum" placeholder="商品库存量"
 ...
 -->
													<div class="form-group">
														...
														<div class="col-sm-3">
															...
															<select name="goodtype.goodtypeId" id="goodtype"
																class="form-control">
																<s:iterator value="#request.goodtypeList" var="g">
																	<option value="<s:property value="#g.goodtypeId" />"><s:property
																			value="#g.goodtypeName" /></option>
																</s:iterator>
															</select>
														</div>
													</div>
