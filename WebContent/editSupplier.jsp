		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="admin_findAll.action"><i
					...
					<div class="col-xs-12">
						<div class="box box-info">
							<div class="box-header">
								<h3 class="box-title">
									<i class="fa fa-user"></i>修改供应商基本信息
								</h3>
							</div>
							<form id="supplier-form" name="supplier-form"
								action="supplier_update.action" class="form-horizontal bv-form"
								novalidate="novalidate">
								<div class="box-body">
									<div class="col-md-6">
										<div class="form-group has-feedback">
											<label for="name" class="col-sm-3 control-label">供应商Id</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" id="supplierId"
													name="supplierId" placeholder="供应商Id"  
													value="<s:property value="#request.supplier.supplierId" />"
													data-bv-field="supplierId"  readonly = "readonly"><i
													class="form-control-feedback" data-bv-icon-for="supplierId"
													style="display: none;"></i> <small
													data-bv-validator="notEmpty"
													data-bv-validator-for="supplierId" class="help-block"
													style="display: none;">请输入供应商Id </small>
											</div>
										</div>
										<div class="form-group has-feedback">
											<label for="supplierName" class="col-sm-3 control-label">供应商名</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" id="supplierName"
													name="supplierName" placeholder="供应商名"
													value="<s:property value="#request.supplier.supplierName" />"
													data-bv-field="supplierName"><i
													class="form-control-feedback"
													data-bv-icon-for="supplierName" style="display: none;"></i>
												<small data-bv-validator="notEmpty"
													data-bv-validator-for="supplierName" class="help-block"
													style="display: none;">请输入供应商名 </small>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												value="<s:property value="#request.supplier.telephone" />"
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="email"
												    value="<s:property value="#request.supplier.email" />"
													name="email" placeholder="Email" data-bv-field="email"><i
													class="form-control-feedback" data-bv-icon-for="email"
													style="display: none;"></i> <small
													data-bv-validator="notEmpty" data-bv-validator-for="email"
													class="help-block" style="display: none;">请输入邮件 </small> <small
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="address"
													...
													value="<s:property value="#request.supplier.address" />"
												/>
											</div>
										</div>
									</div>
