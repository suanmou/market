				...
				<div class="row">
					<div class="box box-info">
										...
										<form id="kind-form" name="kind-form"
											class="form-horizontal bv-form" action="goodtype_update.action"
												...
												<div class="col">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="goodtypeId"
																name="goodtypeId" placeholder="类别Id" value="<s:property value="#request.goodtype.goodtypeId" />"  readonly = "readonly" />
														</div>
													</div>
													<div class="form-group has-feedback">
														...
														<div class="col-sm-8">
															...
															value="<s:property value="#request.goodtype.goodtypeName" />"
