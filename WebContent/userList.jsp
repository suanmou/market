		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
			 ...
			 <ul class="sidebar-menu">
					...
					<li   class="active"><a href="customer_findAll.action"><i
					...
					<div class="col-xs-12">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs pull-right">
								...
								<li class="pull-left header"><i class="fa fa-user"></i> <small>会员列表</small>
								</li>
							</ul>
											...
											<table id="userList"
												...
												<tbody>
													<s:iterator value="#request.list" var="d">
														<tr>
															<td><s:property value="#d.customerId" /></td>
															<td><s:property value="#d.name" /></td>
															<td><s:property value="#d.sex" /></td>
															<td><s:property value="#d.phone" /></td>
															<td><s:property value="#d.code" /></td>
															<td><a
																href="customer_delete.action?customerId=<s:property value="#d.customerId"/>">删除</a>
																<a
																href="customer_findByCustomerId.action?customerId=<s:property value="#d.customerId"/>">修改</a>
															</td>
														</tr>
													</s:iterator>
												</tbody>
								...
								<div class="tab-pane" id="tab-content-edit">
									<div class="box box-info">
										...
										<form id="user-form" name="user-form"
											action="customer_save.action" class="form-horizontal bv-form"
													...
													<div class="form-group has-feedback">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="customerId"
																...
																data-bv-field="customerId"><i
																class="form-control-feedback"
																data-bv-icon-for="customerId" style="display: none;"></i>
