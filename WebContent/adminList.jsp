					...
					<div class="col-xs-12">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs pull-right">
								...
								<li class="pull-left header"><i class="fa fa-user"></i> <small>管理员列表</small>
								</li>
							</ul>
												...
												<tbody>
													<s:iterator value="#request.list" var="d">
														<tr>
															...
															<td><a
																href="admin_delete.action?adminId=<s:property value="#d.adminId"/>">删除</a>
																<a
																href="admin_findByAdminId.action?adminId=<s:property value="#d.adminId"/>">修改</a>
															</td>
														</tr>
													</s:iterator>
												</tbody>
								...
								<div class="tab-pane" id="tab-content-edit">
									<div class="box box-info">
										...
										<form id="user-form" name="user-form"
											class="form-horizontal bv-form" action="admin_save.action"
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="adminId"
																name="adminId" placeholder="管理员Id">
														</div>
													</div>
													<div class="form-group has-feedback">
														<label for="adminName" class="col-sm-3 control-label">姓名</label>

														<div class="col-sm-8">
															<input type="text" class="form-control" id="adminName"
																name="adminName" placeholder="姓名"
																data-bv-field="adminName"><i
																class="form-control-feedback"
																data-bv-icon-for="adminName" style="display: none;"></i>
														...
														<div class="col-sm-8">
															<label class="control-label">
																...
																<div class="iradio_square-green" aria-checked="false"
																	aria-disabled="false" style="position: relative;">
																	<input type="radio" name="sex" data-flag="icheck"
																		class="square-green" value="0" data-bv-field="sex"
																		style="position: absolute; opacity: 0;">
																	<ins class="iCheck-helper"
																		style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
																</div>
																<i class="form-control-feedback" data-bv-icon-for="sex"
													...
													<div class="form-group has-feedback">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="password"
																...
																class="form-control-feedback"
																data-bv-icon-for="password" style="display: none;"></i>
															<small data-bv-validator="notEmpty"
